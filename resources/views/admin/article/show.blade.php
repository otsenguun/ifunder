                ...
                @if(Session::has('article_delete'))
                  ...
                  <div class="box">
                      <div class="box-header">
                          <h4>Article</h4>
                          <div class="btn-group">
                              <a href="{{ url('admin/article/add') }}" type="button" class="btn btn-primary pull-right"><i class="fa fa-plus-circle"></i>Add</a>
                          </div>
                      </div>
                      <div class="box-body">
                              ...
                              <table class="table table-condensed">
                                  ...
                                  @foreach($data as $d)
                                      <tr>
                                          ...
                                          <td><img style="width: 200px;" src="/public/uploads/article/news/{{$d->image}}"></td>
                                          <td style="width: 150px;">
                                              <div class="btn-group">
                                                  <a href="{{ url('admin/article/edit',array($d->id)) }}" type="button" class="btn btn-success"><i class="fa fa-pencil "></i></a>
                                                 <form method="POST" action="{{ url('admin/article/delete', $d->id) }}" class="delete_form">
                                                  {{ csrf_field() }}
