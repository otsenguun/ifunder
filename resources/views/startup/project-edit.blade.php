            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST"
                          action="{{ url('startup/project/change') }}"  enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('project_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="project_name" value="{{$data->project_name}}">
                            </div>
                        ...
                        <div class="form-group{{ $errors->has('year') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="year" value="{{$data->project_generation}}">
                            </div>
                            @if($errors->has('year'))
                                <span class="help-block">
                                {{$errors->first('year')}}
                        ...
                        <div class="form-group{{ $errors->has('cost') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="cost" value="{{$data->project_cost}}">
                        ...
                        <div class="form-group{{ $errors->has('own') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="own" value="{{$data->project_own}}">
                        ...
                        <div class="form-group{{ $errors->has('looking') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="looking" value="{{$data->project_looking}}">
