...
<div class="container">
    ...
    <div class="col-md-9">
        <div class="panel panel-default">
            <div class="panel-heading">An Angel investor</div>
            <div class="panel-body">
                

                <form class="form-horizontal" role="form" method="POST"
                      action="{{ url('angel/profile/addproject/update') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-2">
                            <input id="name" type="number" class="form-control" name="cost"  max="10000000"  required autofocus>
                        </div>
                        <div class="col-md-2">
                            <p>Months to</p>
                        </div>
