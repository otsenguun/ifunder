    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <center>
                    <a href="{{ url('register') }}">
                        <img src="pictures/logostartup.jpg" class="img-circle" alt="Cinque Terre" width="304" height="236" href="{{ url('register') }}" style="padding-bottom: 20px">
                    </a>
                </center>
                    <form class="form-horizontal" role="form" method="POST" action="">
                        {{ csrf_field() }}
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">firtname</label>
                            <div class="col-md-6">
